...
<div class="admin-page dashboard">
    ...
    <div class="welcome-card">
        ...
        <div class="welcome-date">{{ \Carbon\Carbon::now()->locale('id')->isoFormat('dddd, D MMMM YYYY') }}</div>
    </div>
    ...
    <div class="charts-grid">
        <div class="chart-card">
            ...
            <div class="bar-chart-container">
                <div class="bar-chart-wrapper">
                    <div class="custom-bar-chart" id="orderChart"></div>
                </div>
            </div>
        </div>
        ...
        <div class="chart-card">
            ...
            <div class="bar-chart-container">
                <div class="bar-chart-wrapper">
                    <div class="custom-bar-chart" id="revenueChart"></div>
                </div>
            </div>
        </div>
    </div>

    {{-- Recent Orders & Reservations — sekarang benar-benar berdampingan --}}
    <div class="two-columns">
        <div class="recent-card">
            ...
            <div class="recent-item">
                <div class="recent-avatar avatar-order">{{ Str::upper(Str::substr($order->customer_name, 0, 1)) }}</div>
        ...
        <div class="recent-card">
            ...
            <div class="recent-item">
                <div class="recent-avatar avatar-reservasi">{{ Str::upper(Str::substr($reservasi->name, 0, 1)) }}</div>
                <div class="recent-info">
        ...
        <div class="testimoni-grid">
            ...
            <div class="testimoni-card">
                <div class="testimoni-head">
                    <div class="recent-avatar avatar-testimoni">{{ Str::upper(Str::substr($testimoni->name, 0, 1)) }}</div>
                    <div>
                ...
                <div class="testimoni-text">“{{ Str::limit($testimoni->message, 100) }}”</div>
            </div>
            @empty
                ...
                orderHtml += `
                    <div class="bar-item" title="${months[index]}: ${value} Pesanan">
                        <div class="bar" style="height: ${barHeight}px;">
                            ${value > 0 ? `<div class="bar-value">${value}</div>` : ''}
                        </div>
            ...
            revenueData.forEach((value, index) => {
                ...
                revenueHtml += `
                    <div class="bar-item" title="${months[index]}: ${tooltipValue}">
                        <div class="bar bar-revenue" style="height: ${barHeight}px;">
                            ${value > 0 ? `<div class="bar-value bar-value-revenue">${shortValue}</div>` : ''}
                        </div>
                        <div class="bar-label">${months[index]}</div>
                    </div>
                `;
